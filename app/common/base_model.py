"""Módulo de modelos de dados de todas as tabelas."""
...
class AbstractBaseModel(Base):
    """Classe abstrata que cinterá as propriedades base para se auditada."""
    ...
    def as_dict(self) -> dict:
        """Retorna um dicionário com os atributos do objeto."""
        return {
